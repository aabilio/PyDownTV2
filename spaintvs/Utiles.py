...
class PdtVersion(object):
    ...
    # Recordar subir antes los archivos a Downloads aumentar la versión en VERSION
    PDT_VERSION_NIX = _PDT_VERSION_NIX
    PDT_VERSION_WIN = _PDT_VERSION_WIN
    ...
    def get_new_version(self):
        '''
            ...
            y su changelog
        '''
        new_version = Descargar.getHtmlUtf8(self.URL_VERSION)
...
def isScript():
    return True if _TYPE is "script" else False
